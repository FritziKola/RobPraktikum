...
/*  private void initTestInput() {
    ...
    private void initHMKalibrierung() {
    	...
    	Button moveRobot = new Button("Roboter zufällig bewegen");
    	...
    	Button messung = new Button("Messung");
    	messung.setId("messeung");
    	kaliButtons.getChildren().add(messung);
    	Button moveToPoint =new Button("Zu Punkt bewegen");
    	moveToPoint.setId("moveToPoint");
    	kaliButtons.getChildren().add(moveToPoint);
    	Button backToMmButton = new Button("Back to Menu");
		backToMmButton.setId("backToMenu");
